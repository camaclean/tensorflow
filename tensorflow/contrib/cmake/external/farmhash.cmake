...
set(farmhash_BUILD ${CMAKE_CURRENT_BINARY_DIR}/farmhash/src/farmhash_proj)
...
if(WIN32)
  ...
  ExternalProject_Add(farmhash_proj
      PREFIX farmhash
      URL ${farmhash_URL}
...
add_library(farmhash UNKNOWN IMPORTED)
set_target_properties(farmhash PROPERTIES IMPORTED_LOCATION ${farmhash_STATIC_LIBRARIES}) 
add_dependencies(farmhash farmhash_proj)
